<%@ Page Title="" Language="C#" MasterPageFile="~/kullanici.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="AnaSayfa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:DataList ID="DataList2" runat="server" Width="440px" OnSelectedIndexChanged="DataList2_SelectedIndexChanged">
        <ItemTemplate>
